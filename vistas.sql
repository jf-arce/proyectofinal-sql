...
SELECT 
    ...
    c.telefono,
    c.direccion,
    pf.idProducto AS idProducto_favorito,
    p.nombre AS nombre_producto, 
    pf.fechaAgregado AS fechaAgregado_favorito
FROM Usuarios u
JOIN Clientes c ON (c.idCliente = u.idUsuario)
JOIN productosfavoritos pf ON (pf.idUsuario = u.idUsuario)
...
GROUP BY p.idPedido, e.estado, c.nombre;
